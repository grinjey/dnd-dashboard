...
const PlayerList = ({chars, round, rounds, fetchRounds, fight}) => {
    ...
    const sortCharsByInitiative = () => {
        const currentChars = chars.slice();
